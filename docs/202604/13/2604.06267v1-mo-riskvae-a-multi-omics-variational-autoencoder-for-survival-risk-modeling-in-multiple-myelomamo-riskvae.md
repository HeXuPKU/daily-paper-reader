...
result: 适度放宽KL正则化显著提升了生存判别力，且混合潜在空间结构增强了模型对生存风险梯度的捕捉能力。
conclusion: MO-RiskVAE在不引入复杂启发式方法的情况下，通过优化潜在空间设计，实现了比现有模型更稳健且更精准的生存风险分层。
---
