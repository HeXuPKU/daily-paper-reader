...
method: 提出基于组相对策略优化（GRPO）的强化学习框架NavGRPO，通过多样化轨迹探索和组内比较优化导航策略。
result: "在R2R和REVERIE基准上实现了显著的SPL提升，特别是在极端扰动下比基准模型高出14.89%。"
conclusion: 目标导向的强化学习训练能够有效提升视觉语言导航智能体在复杂和动态环境中的鲁棒性。
---
