...
tags: ["query:med-ai"]
score: 8.0
evidence: 评估LLM在病理报告撰写中的应用
tldr: 本研究评估了七种开源大语言模型在辅助编写日语病理报告方面的表现，涵盖了结构化诊断生成、错别字纠正及解释性文本评价三个维度。结果表明，推理型和医学专用模型在结构化任务和纠错中表现更佳，而解释性文本的偏好则因人而异。该研究证明了开源模型在特定临床场景下辅助病理报告编写的实用价值。
selection_source: fresh_fetch
motivation: 旨在探索开源大语言模型在日语病理报告编写辅助任务中的性能表现及其临床应用潜力。
method: 通过结构化诊断生成、日语错别字纠正以及临床医生对解释性文本的主观评价三个维度，对比评估了七种开源LLM。
result: 推理模型和医学专用模型在需要逻辑推理的结构化报告和纠错任务中表现优异，但解释性文本的受众偏好差异较大。
conclusion: 开源大语言模型在特定且具有临床相关性的场景下，能够有效辅助日语病理报告的撰写工作。
---
