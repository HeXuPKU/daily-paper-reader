...
tags: ["query:med-ai"]
score: 10.0
evidence: 用于临床诊断的领域微调大模型医疗推理智能体
...
## 摘要
我们提出了 PULSE，这是一种医疗推理智能体，它将领域微调的大语言模型与科学文献检索相结合，以支持复杂现实案例中的诊断决策。为了评估其能力，我们策划了一个包含 82 份真实内分泌病例报告的基准，涵盖了广泛的疾病类型和发病率水平。在对照实验中，我们将 PULSE 的表现与具有不同专业水平的医生（从住院医师到资深专家）进行了比较，并研究了 AI 辅助如何影响人类的诊断推理。PULSE 达到了具有专家竞争力的准确率，在 Top@1 和 Top@4 阈值下均优于住院医师和初级专家，同时与资深专家的表现相当。与准确率随疾病稀有程度增加而下降的医生不同，PULSE 在不同发病率层级中保持了稳定的表现。该智能体还表现出适应性推理，其输出长度随病例难度增加而增加，这与专家临床医生观察到的较长时间深思熟虑相类似。在协作使用时，PULSE 使医生能够纠正初始错误并拓宽诊断假设，但也引入了自动化偏见的风险。本研究探讨了串行和并行协作工作流，揭示了 PULSE 在常见和罕见表现中均能提供稳健的支持。这些发现强调了基于语言模型的智能体在临床诊断中的前景和局限性，并为评估其在现实决策中的作用提供了一个框架。
