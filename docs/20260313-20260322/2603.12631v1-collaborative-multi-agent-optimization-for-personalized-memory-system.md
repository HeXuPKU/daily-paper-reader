...
tags: ["query:med-ai"]
score: 7.0
evidence: 多智能体系统的强化学习
tldr: 本研究针对个性化大模型中长时对话记忆系统的优化问题，提出了CoMAM框架。传统方法通常独立优化各智能体，忽视了跨智能体协作对全局性能的影响。CoMAM将智能体执行建模为顺序马尔可夫决策过程，通过整合局部任务奖励与全局准确性奖励，并利用排名一致性量化各智能体贡献，实现了多智能体的联合优化。实验证明，该方法在个性化记忆构建与检索任务中显著优于现有系统。
selection_source: fresh_fetch
motivation: 现有记忆系统多采用独立优化各智能体的方法，忽视了智能体间的协作，导致局部优化难以保证全局系统性能。
method: 提出CoMAM框架，将智能体协作建模为顺序MDP，并基于局部与全局奖励的排名一致性动态分配权重进行强化学习优化。
result: 实验结果显示，CoMAM在多项指标上均优于现有的领先记忆系统，验证了联合优化的有效性。
conclusion: 通过协作强化学习联合优化局部智能体，能有效对齐局部改进与全局目标，提升个性化记忆系统的整体效能。
---
